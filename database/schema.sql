...
insert into public.categories (name, slug, image_url, sort_order) values
  ('রেকর্ডেড কোর্স', 'র-কর-ড-ড-ক-র-স', 'https://i.ibb.co.com/5Wfr6n3H/1.png', 1),
  ('সফটওয়্যার ও টুলস', 'সফটওয-য-র-ও-ট-লস', 'https://i.ibb.co.com/ZzsFWX7f/2.png', 2),
  ('ভিডিও বান্ডেল', 'ভ-ড-ও-ব-ন-ড-ল', 'https://i.ibb.co.com/6JtTdf4r/4.png', 3),
  ('ই-বুক', 'ই-ব-ক', 'https://i.ibb.co.com/BVVPX4RN/3.png', 4),
  ('ডিজিটাল টেমপ্লেট', 'ড-জ-ট-ল-ট-মপ-ল-ট', 'https://i.ibb.co.com/SXGzVQcc/6.png', 5),
  ('গ্রাফিক্স অ্যাসেট', 'গ-র-ফ-ক-স-অ-য-স-ট', 'https://i.ibb.co.com/N6hmqw0j/7.png', 6)
...
অফারটি সীমিত সময়ের জন্য, এখনই ''Order Now'' বাটনে ক্লিক করে সংগ্রহ করুন!', 199.0, null, array['https://i.ibb.co.com/fd70Qvxx/image1.png'], 'সফটওয-য-র-ও-ট-লস', true, true, 5.0, 0),
  ('ফেসবুক মনিটাইজেশন কোর্স: এ-টু-জেড আর্নিং মাস্টারক্লাস', 'ফ-সব-ক-মন-ট-ইজ-শন-ক-র-স-এ-ট-জ-ড-আর-ন-ম-স-ট-রক-ল-স', 'ফেসবুক থেকে ইনকাম শুরু করার সম্পূর্ণ গাইডলাইন! অর্গানিক ট্রিকস, পলিসি ইস্যু সমাধান, ভিডিও এডিটিং ও সিক্রেট মেথড শিখে এখনই নিজের আয়ের নতুন যাত্রা শুরু করুন।', 'আপনি কি ফেসবুক থেকে পেজ মনিটাইজ করে প্রতি মাসে ভালো অঙ্কের টাকা আয় করতে চান? আমাদের এই প্র্যাকটিক্যাল "ফেসবুক মনিটাইজেশন কোর্স" আপনাকে শূন্য থেকে ইনকাম শুরু করার প্রতিটি ধাপ সহজ ভাষায় শেখাবে।
...
দেরি না করে আজই এনরোল করুন এবং আপনার অনলাইন আয়ের জার্নি শুরু করুন!', 199.0, null, array['https://i.ibb.co.com/XrwQkW2Y/image.png'], 'র-কর-ড-ড-ক-র-স', true, true, 5.0, 0),
...
অফারটি সীমিত সময়ের জন্য! মাত্র ৯৯ টাকায় পুরো বান্ডেলটি নিতে এখনই অর্ডার বাটনে ক্লিক করুন।', 99.0, null, array['https://i.ibb.co.com/VpLVbBQv/image.png'], 'গ-র-ফ-ক-স-অ-য-স-ট', true, true, 5.0, 0),
  ('১৪০+ প্রিমিয়াম বাংলা ল্যান্ডিং পেজ বান্ডেল (ফ্রি প্লাগিন ও কোর্স সহ)', '১৪০-প-র-ম-য-ম-ব-ল-ল-য-ন-ড-প-জ-ব-ন-ড-ল-ফ-র-প-ল-গ-ন-ও-ক-র-স-সহ', 'ওয়েবসাইটে সেলস ও কনভার্সন বাড়াতে নিয়ে নিন ১৪০+ ইউনিক বাংলা ল্যান্ডিং পেজ টেমপ্লেট বান্ডেল! সাথে পাচ্ছেন প্রয়োজনীয় সব প্রিমিয়াম প্লাগিন, স্টেপ-বাই-স্টেপ ভিডিও টিউটোরিয়াল এবং ফুল ল্যান্ডিং পেজ ডিজাইন কোর্স।', 'আপনার ডিজিটাল প্রোডাক্ট বা ই-কমার্স বিজনেসের বিক্রি বহুগুণ বাড়িয়ে নিতে চান? প্রফেশনাল ল্যান্ডিং পেজ ছাড়া ক্রেতাদের আকর্ষণ করা কঠিন। তাই আপনার জন্য নিয়ে এলাম ১৪০টিরও বেশি রেডিমেড বাংলা ল্যান্ডিং পেজ টেমপ্লেটের বিশাল এক কালেকশন!
...
দেরি না করে আজই আপনার ওয়েবসাইটের জন্য এই মেগা ল্যান্ডিং পেজ বান্ডেলটি সংগ্রহ করুন!', 299.0, null, array['https://i.ibb.co.com/wZKz5MRz/image1.png'], 'ড-জ-ট-ল-ট-মপ-ল-ট', true, true, 5.0, 0),
  ('৪৪+ প্রিমিয়াম আপডেটেড লারাভেল সোর্স কোড মেগা বান্ডেল', '৪৪-প-র-ম-য-ম-আপড-ট-ড-ল-র-ভ-ল-স-র-স-ক-ড-ম-গ-ব-ন-ড-ল', 'ওয়েব ডেভেলপার এবং এজেন্সিগুলোর জন্য বিশাল সুযোগ! একসাথে পাচ্ছেন ৪৪টিরও বেশি ক্যাটাগরির ১০০% ওয়ার্কিং ও আপডেটেড Laravel Source Code (Script)। খুব সহজেই কাস্টমাইজ করে ক্লায়েন্ট বা নিজের জন্য প্রফেশনাল ওয়েব অ্যাপ্লিকেশন তৈরি করুন।', 'আপনি কি কম সময়ে ও ঝামেলা ছাড়াই প্রফেশনাল ওয়েব অ্যাপ্লিকেশন তৈরি করতে চান? আমাদের এই মেগা বান্ডেলে পাচ্ছেন বিভিন্ন ক্যাটাগরির ৪৪+ প্রিমিয়াম লারাভেল (Laravel) সোর্স কোড ও স্ক্রিপ্ট। ডেভেলপার, ফ্রীল্যান্সার এবং আইটি উদ্যোক্তাদের কাজের সময় ও খরচ বহুগুণ বাঁচিয়ে দেওয়ার জন্য এটি একটি সেরা কালেকশন।
...
সীমিত সময়ের বিশেষ অফারে মেগা বান্ডেলটি পেতে এখনই ''Order Now'' বাটনে ক্লিক করুন!', 199.0, null, array['https://i.ibb.co.com/pjysq46q/image.png'], 'ড-জ-ট-ল-ট-মপ-ল-ট', true, true, 5.0, 0),
  ('১ লাখ ৫০ হাজার+ কপিরাইট ফ্রি প্রিমিয়াম রিলস মেগা বান্ডেল', '১-ল-খ-৫০-হ-জ-র-কপ-র-ইট-ফ-র-প-র-ম-য-ম-র-লস-ম-গ-ব-ন-ড-ল', 'ফেসবুক, ইনস্টাগ্রাম ও ইউটিউবে রিলস আপলোড করে ঘরে বসে ইনকাম করতে চান? নিয়ে নিন ১,৫০,০০০+ কপিরাইট ফ্রি প্রিমিয়াম রিলস বান্ডেল! সাথে পাচ্ছেন প্রিমিয়াম হ্যাশট্যাগ ও লাইফটাইম অ্যাক্সেস।', 'ভিডিও তৈরি করার ঝামেলার দিন শেষ! এখন থেকে ভিডিও দিবো আমরা, আর কনটেন্ট ভাইরাল করে পেজ মনিটাইজেশনের মাধ্যমে ইনকাম করবেন আপনি। ফেসবুক রিলস, ইনস্টাগ্রাম রিলস এবং ইউটিউব শর্টস বানিয়ে পেজ গ্রো ও মনিটাইজ করার জন্য এটি একটি কমপ্লিট সলিউশন।
...
বিশেষ অফারে এখনই সংগ্রহ করতে Order Now বাটনে ক্লিক করুন!', 150.0, null, array['https://i.ibb.co.com/DH7qcZc4/image2.png'], 'ড-জ-ট-ল-ট-মপ-ল-ট', true, true, 5.0, 0),
  ('কমপ্লিট ভিসা প্রসেসিং মাস্টারকোর্স', 'কমপ-ল-ট-ভ-স-প-রস-স-ম-স-ট-রক-র-স', 'ইন্ডিয়া, থাইল্যান্ড, ইউকে, ইউএসএ, কানাডাসহ বিশ্বের শীর্ষ দেশগুলোর ভিসা প্রসেসিং শিখুন প্রফেশনাল এক্সপার্টদের কাছ থেকে! নিজের ভিসা নিজে করার পাশাপাশি ট্রাভেল এজেন্সি বা ভিসা প্রসেসিং কনসালটেন্সি শুরু করার সম্পূর্ণ সুযোগ', 'ভিসা প্রসেসিং সংক্রান্ত সঠিক তথ্যের অভাবে এজেন্টদের পেছনে অতিরিক্ত টাকা ও সময় নষ্ট করার দিন শেষ! সেরা এক্সপার্টদের সহায়তায় তৈরি এই কমপ্লিট কোর্সের মাধ্যমে আপনি নিজেই বিভিন্ন দেশের ভিসা আবেদনের সঠিক নিয়ম শিখতে পারবেন। কোর্সে যেসব দেশের ভিসা প্রসেসিং শেখানো হবে: এশিয়ান ও মিডল ইস্ট দেশসমূহ: ইন্ডিয়া, থাইল্যান্ড, মালয়েশিয়া, সিঙ্গাপুর, সৌদি আরব, দুবাই ও জাপান। ইউরোপীয় ও শেনজেন কান্ট্রি: শেনজেন ভিসা, ইউকে (যুক্তরাজ্য), ইতালি ও সুইডেন। আমেরিকা ও অন্যান্য দেশ: ইউএসএ (যুক্তরাষ্ট্র), কানাডা ও অস্ট্রেলিয়া। কোর্সের মূল সুবিধা ও বৈশিষ্ট্য: নিজের ভিসা নিজে করুন: কোনো থার্ড-পার্টি এজেন্টের ওপর নির্ভর না করে ১০০% সঠিক নিয়মে ফরম পূরণ ও ফাইল সাবমিট করার টেকনিক। সেরা এক্সপার্টদের গাইডলাইন: দীর্ঘ অভিজ্ঞতাসম্পন্ন ভিসা কনসালটেন্টদের বাস্তব কাজের অভিজ্ঞতা থেকে শেখার সুবিধা। স্মার্ট ক্যারিয়ার ও বিজনেস: কোর্সটি সম্পন্ন করে ট্রাভেল এজেন্সি বা স্বাধীনভাবে ভিসা প্রসেসিং ফ্রিল্যান্সিং সার্ভিস শুরু করতে পারবেন। নিজের অথবা ক্লায়েন্টের ভিসা প্রসেসিং প্রফেশনালি করতে এখনই Order Now বাটনে ক্লিক করে এনরোল করুন!
', 199.0, null, array['https://i.ibb.co.com/kgWq1km3/image1.png'], 'র-কর-ড-ড-ক-র-স', true, true, 5.0, 0)
