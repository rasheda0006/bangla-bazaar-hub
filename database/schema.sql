...
create table if not exists public.site_settings (
  ...
  -- হিরো টেক্সট কাস্টমাইজেশন
  hero_badge_text text not null default 'নতুন ডিজিটাল কালেকশন লাইভ',
  hero_secondary_cta_text text not null default 'সব প্রোডাক্ট',
  hero_secondary_cta_link text not null default '/shop',
  hero_trust_text text not null default 'নিরাপদ পেমেন্ট',
  hero_customers_text text not null default '১০,০০০+ গ্রাহক',
  hero_delivery_badge_text text not null default 'ইনস্ট্যান্ট ডেলিভারি',
  -- SEO / সোশ্যাল শেয়ার
  og_image_url text,
  og_description text,
  fb_capi_access_token text,
  tiktok_url text,
  -- পেমেন্ট নির্দেশনা (চেকআউট পেজে দেখাবে)
  payment_instructions text default 'সেন্ড মানি করার পর ট্রানজেকশন আইডি ও যে নম্বর থেকে পাঠিয়েছেন তা নিচে লিখুন।',
  -- হেডার ও ফুটার
  ...
  footer_bg_color text not null default '#f3f5f7',
  footer_text_color text not null default '#0f172a',
  footer_about text,
  footer_links_title text not null default 'দ্রুত লিংক',
  footer_contact_title text not null default 'যোগাযোগ',
  footer_copyright text,
  -- সেকশন হেডিং কাস্টমাইজেশন
  sec_categories_title text not null default 'ক্যাটাগরি',
  sec_categories_subtitle text not null default 'আপনার পছন্দের ক্যাটাগরি বেছে নিন',
  sec_best_title text not null default 'বেস্ট সেলিং ডিজিটাল প্রোডাক্ট',
  sec_best_subtitle text not null default 'সবচেয়ে বেশি বিক্রি হওয়া কোর্স, টুলস ও সাবস্ক্রিপশন',
  sec_suggested_title text not null default 'আপনার জন্য সাজেস্টেড',
  sec_suggested_subtitle text not null default 'আপনার পছন্দ হতে পারে এমন ডিজিটাল প্রোডাক্ট',
  sec_all_title text not null default 'সব ডিজিটাল প্রোডাক্ট',
  sec_all_subtitle text not null default 'কোর্স, টুলস, সাবস্ক্রিপশন, ই-বুক ও টেমপ্লেট',
  sec_testimonials_title text not null default 'কাস্টমার রিভিউ',
  sec_testimonials_subtitle text not null default 'আমাদের ক্রেতারা যা বলছেন',
  sec_proof_title text not null default 'অর্ডার প্রুফ',
  sec_proof_subtitle text not null default 'আমাদের কাছ থেকে যারা অর্ডার করেছেন',
  show_proofs boolean not null default true,
